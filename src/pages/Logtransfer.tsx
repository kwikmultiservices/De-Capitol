...
import { getTransaction, gettransger, getuser } from "../Services/GetUser.service";
    ...
    <div className="h-screen flex">
      ...
      >
        ...
        <div className="p-4 h-[85vh] overflow-y-scroll scrollbar-hide">
         <TransferLogTable user={user as User} log={transaction} getUsers={getU} isAdmin={user?.permission === "admin" ?true :false}/>
        </div>
      </div>
    </div>
  );
